...
class NewsManagerPDO extends NewsManager
{
  ...
  private $cache;
  private $listeNewsFichier = 'liste-news.html';

  public function __construct() {
    $this->$cache = new Cache();
  }
  ////////// fin nouvelles modifications
...
////////// nouvelles modifications
    ...
    $listeNewsContenu = $this->readCache($listeNewsFichier);
    if ($listeNewsContenu == null) {
...
// code déjà écrit précédemment
      ...
      $listeNewsContenu = $requete->fetchAll();
      foreach ($listeNewsContenu as $news) {
        $news->setDateAjout(new \DateTime($news->dateAjout()));
        $news->setDateModif(new \DateTime($news->dateModif()));
      }
      $requete->closeCursor();
// fin du code déjà écrit

      $this->$cache->writeCache($listeNewsFichier, $listeNewsContenu);
    }
    return $listeNewsContenu;
  }
////////// fin nouvelles modifications
